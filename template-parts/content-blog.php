	...
	<div class="entry-content">
		...
		<ul class="flex md:flex-row flex-col md:items-center gap-2 my-5">
			<li class="text-sm font-normal text-accent flex items-center gap-2">
				...
				<a class="text-xs font-medium text-accent" href="">Posted by
					<?php the_author(); ?></a>
			</li>
			<li class="text-sm font-normal text-accent flex items-center gap-2">
				...
				<a class="text-xs font-medium text-accent" href=""><?php printwish_posted_on(); ?></a>
			</li>
		</ul>
		<div class="w-full mb-5">
			<img src="https://printwish.co.uk/wp-content/themes/printwishwp/public//images/6.webp" alt="feature"
