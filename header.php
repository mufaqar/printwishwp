...
<a href="http://localhost/dev1/enquire-now" class="md:text-base text-xs fixed bottom-5 right-5 bg-green-500 py-3 md:px-6 px-4 hover:bg-primary rounded-full text-white" style="z-index: 11111">
    Quick Quote
</a>
</button>