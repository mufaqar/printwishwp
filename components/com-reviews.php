...
<section class='py-2 max-w-screen-xl mx-auto px-4 relative '>
    <div class='max-w-screen-xl mx-auto px-4'>
        <div class='w-fit mx-auto'>
            <h2
                class='sm:text-3xl hidden md:block  text-2xl font-semibold font-opensans text-accent uppercase text-center mb-5'>
		...
		if (have_posts()) :  while (have_posts()) : the_post(); ?>
                <div class="px-2">
                    <div class="bg-white p-3 flex flex-col gap-4">
                        ...
                        <p class="text-sm font-normal flex items-center gap-2 border rounded-full badge">
                    ...
                    <!-- <img src="<?php bloginfo('template_directory'); ?>/public/<?php echo $item['img']; ?>" alt="image"
                        width='500' height='200' class='mx-auto' /> -->
                </div>
