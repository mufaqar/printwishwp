...
<main class="loc_banner w-full relative flex justify-center" style="background-color: #F42098">
    ...
    <h2 class="absolute top-2 md:top-5 md:text-white text-2xl sm:text-4xl md:text-6xl font-semibold right-4">
        <?php the_title()?></h2>
</main>
    ...
    <div class='sm:mb-10 mb-5'>
        ...
        <section class="grid col-span-2 lg:grid-cols-4 gap-y-10 gap-3 lg:gap-5">
            <div class="col-span-2">
                ...
                <a href="<?php echo home_url('/enquire-now'); ?>"
                    class="md:text-base text-xs bg-green-500 py-3 md:px-6 px-4 hover:bg-primary rounded-full text-white">
                    Quick Quote
                </a>
            </div>
            <div class="">
